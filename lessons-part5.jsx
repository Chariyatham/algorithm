...
const MIDTERM = [
  ...
  {
    q: "7. Binary Search หา 22 ใน [10,12,13,16,18,19,20,22,23,24] ใช้กี่ <b>iteration</b> ของ while loop?",
    pts: 5,
    a: "2 iterations",
    explain: "iter 1: lo=0,hi=9,mid=4 (a[4]=18) → 18<22 → lo=5; iter 2: lo=5,hi=9,mid=7 (a[7]=22) → พบ! ใช้ 2 รอบของ while"
  },
  {
...
const FINAL = [
  ...
  },
  {
    ...
    pts: 10,
    a: "3 — (1,4), (5,7), (8,9)",
    explain: "เรียงตาม f: (1,4),(3,5),(0,6),(5,7),(8,9),(5,9). เลือก: (1,4) lastEnd=4 → (3,5)(0,6) ข้าม → (5,7) lastEnd=7 → (8,9) lastEnd=9 → (5,9) ข้าม = 3"
  },
  {
  ...
  },
  {
    ...
    pts: 8,
    a: "3 เซต: {3,5}, {3,4,1}, {5,2,1}",
    explain: "ตรวจครบ: pair {3,5}=8; triples {3,4,1}=8, {5,2,1}=8; quads ขนาดเล็กสุด 1+2+3+4=10>8 → ไม่มี"
  },
  {
