...
∴ 100n + 5 = O(n²) ด้วย c = 105, n₀ = 1 ▢`
  ...
  },
  {
    ...
    questions: [
      {
        q: "Trace <b>Shell Sort</b> ของ arr = [16, 25, 2, 54, 36, 9, 12, 66] โดยใช้ Shell's original (gap = n/2, แล้ว ÷ 2 ทุกรอบ) (8 คะแนน)",
        hint: "n=8 → gaps = 4, 2, 1. แต่ละ gap ทำ insertion sort ใน group ที่ห่างกัน gap ตำแหน่ง",
        ans: `Initial:           16 25 2 54 36 9 12 66

gap=4: groups (idx 0,4)(1,5)(2,6)(3,7)
  (16,36) ok  ·  (25,9)→swap→(9,25)  ·  (2,12) ok  ·  (54,66) ok
  → 16 9 2 54 36 25 12 66

gap=2: groups (idx 0,2,4,6)=[16,2,36,12] และ (1,3,5,7)=[9,54,25,66]
  group 1 insertion: [16,2,36,12] → [2,12,16,36]
  group 2 insertion: [9,54,25,66] → [9,25,54,66]
  → 2 9 12 25 16 54 36 66

gap=1: insertion sort เต็ม
  i=4 (16): swap กับ 25 → 2 9 12 16 25 54 36 66
  i=6 (36): swap กับ 54 → 2 9 12 16 25 36 54 66

✓ sorted: 2 9 12 16 25 36 54 66`
      },
      {
...
✓ คำตอบเซตย่อย: {10, 2} → 10+2 = 12
  (Subset เดียวที่ sum = 12 ใน A = {25, 10, 9, 2}; กิ่งอื่นถูก prune หรือไม่ตรง)`
      },
      {
...
⚠ Pseudo-polynomial: poly ใน n และ W แต่ input size = n + log W bits (W เขียนเป็น binary) → ไม่ poly ในความยาว input จริง`
      }
    ]
  },
  {
